    ...
    return createElement(
        ...
        [
            ...
            createElement(
                ...
                [
                    sydDOM.mainPanelText_names_header({content:'Product'}),
                    sydDOM.createLinkBtn({content:'Products',type:'shop'}),
                    sydDOM.createLinkBtn({content:'Profile',type:'shop'}),
                    sydDOM.createLinkBtn({content:'Contact',type:'shop'}),
...
sydDOM.createLinkBtn = ({content,link = true,type = ''}) =>{
    ...
    return createElement(
        link === true ? 'a' : 'p',
        {
            style:sydDOM.mainPanelText_names().inherit(['attribute','style']) + ';color:#000;text-transform:capitalize;font-weight:300;font-size:13px;',
            ...linkAttr(),
            class:'click'
        },
        [
