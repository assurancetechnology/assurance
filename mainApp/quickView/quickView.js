            ...
            createElement(
                ...
                [
                    ...
                    createElement(
                        'div',
                        {
                            style:`height:100%;min-height:300px;width:50%;min-width:270px;background-image:url()`+styleComponent.bg(),//;background-image:url("http://localhost:9090/image?icons=chat")
                            class:'thinBorder'
                        }
                    ),
                    createElement(
