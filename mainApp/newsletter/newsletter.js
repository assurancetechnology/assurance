            ...
            createElement(
                ...
                [
                    ...
                    createElement(
                        'div',
                        {
                            style:'height:100%;display:flex;justify-content:center;align-items:center;padding:0 20px;font-weight:500;color:#fff;background:#000;text-transform:capitalize',
                            class:'click'
                        },
                        [
                            'subscribe'
