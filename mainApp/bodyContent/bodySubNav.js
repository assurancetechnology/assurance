...
setStyle([
    {
        ...
        style:{
            ...
            alignItems:'center',
            padding:'0 10px',
            background:"rgba(21, 202, 252, 0.5)"
        }
    }
])
...
sydDOM.bodySubNav = () =>{
    return createElement(
        'div',
        {
            style:'padding:10px;width:100%;display:flex;justify-content:space-around;row-gap:20px;column-gap:20px;flex-wrap:wrap;background:linear-gradient(to right bottom, #1097f3,#15cbfc)',
            class:'thinBorder'
        },
        [
