    ...
    return createElement(
        ...
        [
            createElement(
                ...
                [
                    sydDOM.createMainMenuLinkBtn({content:'profile'}),
                    sydDOM.createMainMenuLinkBtn({content:'products'}),
                    sydDOM.createMainMenuLinkBtn({content:'contact'}),
...
sydDOM.acccount = () =>{
    ...
    return createElement(
        'div',
        {
            style:styleComponent.menuBox({method:'add',style:{opacity:'.3',pointerEvents:'none'}}),
            // onclick:'goToLogin()',
...
sydDOM.likeHeart1 = () =>{
    return createElement(
        'div',
        {
            style:styleComponent.menuBox({method:'add',style:{opacity:'.3',pointerEvents:'none'}}) + `display:${preState(['likeHeart1','d'],'none')}`
        },
        [
...
sydDOM.cart1 = () =>{
    ...
    return createElement(
        'div',
        {
            style:styleComponent.menuBox({method:'add',style:{opacity:'.3',pointerEvents:'none'}}) + 'position:relative',
...
sydDOM.createMainMenuLinkBtn = ({content}) =>{
    ...
    return createElement(
        'a',
        {
            style:'padding:10px 20px;position:relative;color:#15cbfc',
            class:'click',
        ...
        [
            content,
            createElement('span',{style:`position:absolute;top:calc(100%);left:50%;transform:translateX(-50%);height:1px;width:${content === category ? '100%' : '0%'};background:#15cbfc;transition:all ease-in .2s;`})
        ]
    )
}
